...
<body>
    ...
    <div class="container-wrapper">
        <div class="container">
            <div class="image">
                <img src="inventario.png.png" alt="Logo" style="width: 100%; height: 300px; border-radius: 10px;">
            </div>
            <div class="card">
        ...
        <div class="container">
            <div class="image">
                <img src="cobro.png" alt="Logo" style="width: 100%; height: 300px; border-radius: 10px;">
            </div>
            <div class="card">
